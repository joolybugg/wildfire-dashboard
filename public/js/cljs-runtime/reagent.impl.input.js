...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__11947){
var map__11948 = p__11947;
var map__11948__$1 = cljs.core.__destructure_map(map__11948);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11948__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
var _STAR_force_set_dom_value_STAR__orig_val__11955 = reagent.impl.input._STAR_force_set_dom_value_STAR_;
var _STAR_force_set_dom_value_STAR__temp_val__11956 = true;
(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__temp_val__11956);
...
}finally {(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__orig_val__11955);
}}));
} else {
...
(jsprops.onChange = (function (p1__11961_SHARP_){
return reagent.impl.input.input_handle_change(this$,on_change,p1__11961_SHARP_);
}));
