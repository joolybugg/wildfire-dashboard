...
var G__11969 = o;
reagent.impl.template.goog$module$goog$object.set(G__11969,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__11970 = o;
reagent.impl.template.goog$module$goog$object.set(G__11970,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__12005__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__12007__i < G__12007__a.length) {G__12007__a[G__12007__i] = arguments[G__12007__i + 0]; ++G__12007__i;}
  args = new cljs.core.IndexedSeq(G__12007__a,0,null);
} 
return G__12005__delegate.call(this,args);};
G__12005.cljs$lang$maxFixedArity = 0;
G__12005.cljs$lang$applyTo = (function (arglist__12008){
var args = cljs.core.seq(arglist__12008);
return G__12005__delegate(args);
});
...
var G__11971 = props;
var G__11971__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__11971,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__11971);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__11971__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5162__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__11972 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__11972,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__11972;
}
})(),id_class);
...
var G__11973 = (cljs.core.count(argv) - first_child);
switch (G__11973) {
case (0):
...
var vec__11974 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11974,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11974,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11974,(2),null);
...
var temp__5829__auto___12024 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___12024 == null)){
} else {
var key_12025 = temp__5829__auto___12024;
(jsprops.key = key_12025);
}
...
var temp__5829__auto___12026 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___12026 == null)){
} else {
var key_12027 = temp__5829__auto___12026;
(jsprops.key = key_12027);
}
...
var temp__5829__auto___12029 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___12029 == null)){
} else {
var key_12030 = temp__5829__auto___12029;
(jsprops.key = key_12030);
}
...
var temp__5829__auto___12039 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___12039 == null)){
} else {
var key_12040 = temp__5829__auto___12039;
(jsprops.key = key_12040);
}
...
var temp__5829__auto___12041 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___12041 == null)){
} else {
var key_12043 = temp__5829__auto___12041;
(jsprops.key = key_12043);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__11977_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__11977_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__11978 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11978,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11978,(1),null);
...
break;
default:
var G__12046 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__12047 = compiler;
v = G__12046;
compiler = G__12047;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template11984 = (function (opts,id,fn_to_element,parse_fn,meta11985){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template11984.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_11986,meta11985__$1){
var self__ = this;
var _11986__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template11984(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta11985__$1));
}));

(reagent.impl.template.t_reagent$impl$template11984.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_11986){
var self__ = this;
var _11986__$1 = this;
return self__.meta11985;
}));

(reagent.impl.template.t_reagent$impl$template11984.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template11984.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template11984.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template11984.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template11984.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template11984.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta11985","meta11985",-1046689774,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template11984.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template11984.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template11984");

(reagent.impl.template.t_reagent$impl$template11984.cljs$lang$ctorPrWriter = (function (this__5455__auto__,writer__5456__auto__,opt__5457__auto__){
return cljs.core._write(writer__5456__auto__,"reagent.impl.template/t_reagent$impl$template11984");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template11984.
 */
reagent.impl.template.__GT_t_reagent$impl$template11984 = (function reagent$impl$template$__GT_t_reagent$impl$template11984(opts,id,fn_to_element,parse_fn,meta11985){
return (new reagent.impl.template.t_reagent$impl$template11984(opts,id,fn_to_element,parse_fn,meta11985));
});
...
return (new reagent.impl.template.t_reagent$impl$template11984(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
