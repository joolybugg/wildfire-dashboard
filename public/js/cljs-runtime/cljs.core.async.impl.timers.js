...
var i_15128 = (0);
while(true){
if((i_15128 < arr.length)){
(arr[i_15128] = null);

var G__15130 = (i_15128 + (1));
i_15128 = G__15130;
continue;
} else {
}
...
var i_15155 = (self__.level + (1));
while(true){
if((i_15155 <= (new_level + (1)))){
(update[i_15155] = self__.header);

var G__15161 = (i_15155 + (1));
i_15155 = G__15161;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_15168 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_15168[i]));
} else {
x__$2.forward.push((((i < links_15168.length))?(links_15168[i]):null));
}

if((i < links_15168.length)){
(links_15168[i] = x__$2);
} else {
links_15168.push(x__$2);
}
...
var i_15175 = (0);
while(true){
if((i_15175 <= self__.level)){
var links_15178 = (update[i_15175]).forward;
if((x__$1 === (((i_15175 < links_15178.length))?(links_15178[i_15175]):null))){
(links_15178[i_15175] = (x__$1.forward[i_15175]));

var G__15179 = (i_15175 + (1));
i_15175 = G__15179;
continue;
} else {
var G__15180 = (i_15175 + (1));
i_15175 = G__15180;
continue;
}
} else {
...
var G__15192 = nx;
var G__15193 = (level__$1 - (1));
x = G__15192;
level__$1 = G__15193;
continue;
} else {
var G__15194 = x;
var G__15195 = (level__$1 - (1));
x = G__15194;
level__$1 = G__15195;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__15203 = nx;
var G__15204 = (level__$1 - (1));
x = G__15203;
level__$1 = G__15204;
continue;
} else {
var G__15205 = x;
var G__15206 = (level__$1 - (1));
x = G__15205;
level__$1 = G__15206;
continue;
}
